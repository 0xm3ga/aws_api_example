...
from aws.api.v1.src.lambdas.goodbye_lambda.app import (
    generate_response,
    greet_user,
    handle_exception,
    lambda_handler,
...
app_module = "aws.api.v1.src.lambdas.goodbye_lambda.app"
...
@patch(f"{app_module}.greet_user", return_value={"message": "Goodbye, Test!"})
